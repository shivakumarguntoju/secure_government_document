...
export const useDocuments = (filters = {}) => {
  ...
  const fetchDocuments = async () => {
    ...
    try {
      ...
      // Apply document type filter if needed here
      ...
      // Only declare formattedDocs once
      const formattedDocs = docs
        .map(doc => ({
          ...doc,
          uploadedAt: doc.uploadedAt?.toDate?.() || new Date(),
        }))
        // Further client-side filtering/sorting (if needed)
  ...
  // ... (rest of your hook as before: getDocument, downloadDocument, updateDocument, deleteDocument, searchDocuments, useEffect...)
